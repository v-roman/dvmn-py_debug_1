...
# Код для проверки:   print(get_author)
                    # print(get_book_by_id('1', 'AAECTkuGjWo1Imwr-_6UrN-nzbo89sd3WSM'))
# Установленный факт: ответ в терминале <function get_author at 0x000001D1B49E3B00>
# Вывод: гипотеза верна, ошибка во вложенной функции
